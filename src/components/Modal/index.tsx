...
export function Modal() {
  const { showModal, setShowModal, dataInput, setDataInput } = useJobs();
              ...
              >
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  >
                    ...
                    <Input.Root>
                      <Input.Label className="text-white" htmlFor="phone" text="Phone" />
                      <Input.InputCustom
                        id="phone"
                        type="tel"
                        name="phone"
                    ...
                    <Input.Root>
                      <Input.Label className="text-white" htmlFor="state" text="State" />
                      <Input.InputCustom
                        id="state"
                        type="text"
                        name="state"
